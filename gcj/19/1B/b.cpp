...
void solve()
{
    ...
    rep(i, 101) {
        ...
        int roku = data[5] - data[4] - ichi * repow(2, 30-5, MOD) - ni * repow(2, 30/2-2, MOD) - san * repow(2, 30/3-1, MOD)
            - yon * repow(2, 30/4-1, MOD) - go * repow(2, 30/5-1, MOD);
